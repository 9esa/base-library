...
import org.zuzuk.dataproviding.database.DBUtils;
 ...
 */
public class IteratorInitializationRequest<TItem> implements Task<IteratorInitializationRequest.Response> {
    ...
    public IteratorInitializationRequest(QueryBuilder<TItem, ?> queryBuilder, RuntimeExceptionDao<TItem, ?> dao, boolean isKnownCount) {
        this.queryBuilder = queryBuilder;
        this.dao = dao;
        this.isKnownCount = isKnownCount;
    }

    public IteratorInitializationRequest(Where<TItem, ?> where, RuntimeExceptionDao<TItem, ?> dao, boolean isKnownCount) {
        this.where = where;
        this.dao = dao;
        this.isKnownCount = isKnownCount;
    }
